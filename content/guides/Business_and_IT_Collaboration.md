...
{{<figure src="/assets/img/guides/BusITCollaboration.png"
  alt="Business and IT collaboration"
  class="display-block margin-x-auto maxw-mobile">}}
...
* Virtual prioritization, tasking, and [visually track status](/guides/visibility_and_status/) in an agile environment - top available tools include JIRA, Rally, VersionOne, Trello, etc.
