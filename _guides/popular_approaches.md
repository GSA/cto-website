...
Scrum is neither synonymous with Agile nor with an "[increment]({{ site.baseurl }}/guides/agile_glossary/)" (i.e. a Sprint / Iteration); it is not a tool (i.e. JIRA, Rally, etc.), but the Scrum process can be supported by one.
