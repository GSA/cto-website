...
|Deliver useable increment at the end of Sprint 0 and review progress to garner feedback from Key Stakeholders <br>Feedback should be reviewed & prioritized by the Product Owner for incorporation into future sprint(s)| {::nomarkdown}<ul><li>Conducting a Sprint Review (Demo)</li></ul>{:/}|
