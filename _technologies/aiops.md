...
![An example bar graph showing Apdex scores. The bar graph displays what percent of page load time is tolerable versus frustrating.](/assets/files/techradar/apdex.png "Example Graph")
...
![Graph showing a decrease in human operational workload over time as AIOps is implemented. This is implemented via: Event data normalization and enrichment; change and incident correlation; pattern-based event grouping; tools integration; and automation.](/assets/files/techradar/aiops-vs-human-operational-workload.png "Source: Datanami")
...
![Diagram indicating how events, metrics, traces, topology, incidents, dependencies and changes feed into an AIOps platform, and the platform in turn produces analyses and automation from the data.](/assets/files/techradar/gartner-aiops-cycle.png "Source: Gartner")
...
![A diagram indicating the various types of AI adoption across government. They are: chatbots or conversational agents; machine learning supported data mining; biometrics; computer vision and automated image recognition; GeoAI; machine translation; and deep learning.](/assets/files/techradar/gartner-federal-aiops-adoption.png "Source: Gartner")
...
![Screenshot of the GSA eLibrary page](/assets/files/techradar/elibrary-searchbar.jpg "The GSA eLibrary")
...
![New Relic logo](/assets/files/techradar/newrelic.png)
...
![Datadog logo](/assets/files/techradar/datadog.png)
...
![Dynatrace logo](/assets/files/techradar/dynatrace.png)
...
![Appdynamics logo](/assets/files/techradar/appdynamics.png)
...
![Devo logo](/assets/files/techradar/devo.png)
